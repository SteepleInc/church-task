...
export const listForChurch = registeredFunctions.teams.listForChurch;
export const listMembershipsForChurch = registeredFunctions.teams.listMembershipsForChurch;
...
export const updateProductFields = registeredFunctions.teams.updateProductFields;
