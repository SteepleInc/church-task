...
import { CycleTableFieldsSchema } from "@church-task/domain-old/Cycle";
import { LabelTableFieldsSchema } from "@church-task/domain-old/Label";
import { TaskTableFieldsSchema } from "@church-task/domain-old/Task";
import {
...
} from "@church-task/domain-old/Template";
import {
  WorkflowStatusTableFieldsSchema,
  WorkflowTableFieldsSchema,
} from "@church-task/domain-old/Workflow";
