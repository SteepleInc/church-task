...
- `CONTEXT.md` at the repo root defines the project's domain language.
- `docs/adr/` at the repo root contains architectural decision records.

There is no `CONTEXT-MAP.md` and no per-context `src/<context>/docs/adr/` layout at the time this file was created.
