...
Old-stack persistence/runtime packages and starter billing integrations are not part of the architecture. There is no data migration because there were no production users or data to preserve. Current Church Work domain language remains stable; this was a persistence/runtime migration, not a domain-model rewrite.
